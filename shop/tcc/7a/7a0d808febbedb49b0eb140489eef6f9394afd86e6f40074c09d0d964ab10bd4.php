...
";
    ...
    <div class=\"row\">
        ...
        echo "\" />
                            <span class=\"d-block mt-2\"><input type=\"submit\" name=\"add_to_cart\" value=\"Купить\" class=\"btn btn-warning mt-3\" style=\"width: 262px; align-self: center;\" /></span>
                        </form>
                    <span class=\"d-block mt-2\"> <a style=\"width: 262px;\"  class=\"btn  btn-outline-dark\" href=\"?class=catalog&method=viewCatalog\">Вернуться в каталог</a></span>
                </div>
            </div>
        <br>
        <br>
